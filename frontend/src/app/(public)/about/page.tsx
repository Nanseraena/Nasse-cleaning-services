...
export default function AboutPage() {
  return <main className="overflow-hidden bg-[#fbfcf9] text-brand-ink">
    <section className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 pb-20 pt-10 md:pb-28 md:pt-16">
    ...
    <section className="border-y border-brand-ink/10 bg-white">
      <div className="mx-auto grid max-w-[1400px] gap-12 px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:grid-cols-[2fr_3fr]">
    ...
    <section className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-16 md:py-24">
