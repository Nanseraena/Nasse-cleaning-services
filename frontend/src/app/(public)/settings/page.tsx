...
export default function SettingsPage() {
  ...
  if (!initialized || !authenticated || !user) return <div className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 lg:px-8 py-10 text-slate-600">Checking your session…</div>;

  const displayName = [user.first_name, user.last_name].filter(Boolean).join(" ") || user.email;
  return <div className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 lg:px-8 py-10 md:py-14">
