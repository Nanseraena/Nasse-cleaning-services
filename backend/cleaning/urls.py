...
from .views import LoginView, SignupView, RefreshView, LogoutView, MeView, ServiceListView, ServiceDetailView, QuoteCreateView, CorporateEnquiryCreateView, ContactMessageCreateView, AdminQuoteListView, AdminQuoteDetailView, AdminCorporateListView, AdminContactListView, CustomerBookingListCreateView, CustomerBookingDetailView, AdminBookingListView, AdminBookingDetailView
urlpatterns=[
 ...
 path("services/",ServiceListView.as_view()),path("services/<slug:slug>/",ServiceDetailView.as_view()),path("quotes/",QuoteCreateView.as_view()),path("corporate-enquiries/",CorporateEnquiryCreateView.as_view()),path("contact-messages/",ContactMessageCreateView.as_view()),
